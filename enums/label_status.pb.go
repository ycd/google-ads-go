...
var file_enums_label_status_proto_goTypes = []interface{}{
	(LabelStatusEnum_LabelStatus)(0), // 0: google.ads.googleads.v7.enums.LabelStatusEnum.LabelStatus
	(*LabelStatusEnum)(nil),          // 1: google.ads.googleads.v7.enums.LabelStatusEnum
}
