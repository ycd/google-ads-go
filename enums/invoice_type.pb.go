...
var file_enums_invoice_type_proto_goTypes = []interface{}{
	(InvoiceTypeEnum_InvoiceType)(0), // 0: google.ads.googleads.v7.enums.InvoiceTypeEnum.InvoiceType
	(*InvoiceTypeEnum)(nil),          // 1: google.ads.googleads.v7.enums.InvoiceTypeEnum
}
