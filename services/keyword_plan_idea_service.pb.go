...
type GenerateKeywordIdeasRequest struct {
	...
	// Targeting network.
	KeywordPlanNetwork enums.KeywordPlanNetworkEnum_KeywordPlanNetwork `protobuf:"varint,9,opt,name=keyword_plan_network,json=keywordPlanNetwork,proto3,enum=google.ads.googleads.v7.enums.KeywordPlanNetworkEnum_KeywordPlanNetwork" json:"keyword_plan_network,omitempty"`
	// The keyword annotations to include in response.
	KeywordAnnotation []enums.KeywordPlanKeywordAnnotationEnum_KeywordPlanKeywordAnnotation `protobuf:"varint,17,rep,packed,name=keyword_annotation,json=keywordAnnotation,proto3,enum=google.ads.googleads.v7.enums.KeywordPlanKeywordAnnotationEnum_KeywordPlanKeywordAnnotation" json:"keyword_annotation,omitempty"`
...
var file_services_keyword_plan_idea_service_proto_rawDesc = []byte{
	...
	0x76, 0x37, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x4b, 0x65, 0x79, 0x77, 0x6f, 0x72, 0x64,
	...
	0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c,
	0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x37, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x4b,
	...
	0x61, 0x64, 0x73, 0x2e, 0x76, 0x37, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x4b, 0x65,
	...
	0x3d, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x37, 0x22, 0x32, 0x2f, 0x76, 0x37, 0x2f, 0x63, 0x75, 0x73,
	...
	0x64, 0x73, 0x2e, 0x76, 0x37, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x1b,
...
var file_services_keyword_plan_idea_service_proto_goTypes = []interface{}{
	(*GenerateKeywordIdeasRequest)(nil),                  // 0: google.ads.googleads.v7.services.GenerateKeywordIdeasRequest
	(*KeywordAndUrlSeed)(nil),                            // 1: google.ads.googleads.v7.services.KeywordAndUrlSeed
	(*KeywordSeed)(nil),                                  // 2: google.ads.googleads.v7.services.KeywordSeed
	(*SiteSeed)(nil),                                     // 3: google.ads.googleads.v7.services.SiteSeed
	(*UrlSeed)(nil),                                      // 4: google.ads.googleads.v7.services.UrlSeed
	(*GenerateKeywordIdeaResponse)(nil),                  // 5: google.ads.googleads.v7.services.GenerateKeywordIdeaResponse
	(*GenerateKeywordIdeaResult)(nil),                    // 6: google.ads.googleads.v7.services.GenerateKeywordIdeaResult
	(enums.KeywordPlanNetworkEnum_KeywordPlanNetwork)(0), // 7: google.ads.googleads.v7.enums.KeywordPlanNetworkEnum.KeywordPlanNetwork
	(enums.KeywordPlanKeywordAnnotationEnum_KeywordPlanKeywordAnnotation)(0), // 8: google.ads.googleads.v7.enums.KeywordPlanKeywordAnnotationEnum.KeywordPlanKeywordAnnotation
	(*common.KeywordPlanAggregateMetrics)(nil),                               // 9: google.ads.googleads.v7.common.KeywordPlanAggregateMetrics
	(*common.HistoricalMetricsOptions)(nil),                                  // 10: google.ads.googleads.v7.common.HistoricalMetricsOptions
	(*common.KeywordPlanAggregateMetricResults)(nil),                         // 11: google.ads.googleads.v7.common.KeywordPlanAggregateMetricResults
	(*common.KeywordPlanHistoricalMetrics)(nil),                              // 12: google.ads.googleads.v7.common.KeywordPlanHistoricalMetrics
	(*common.KeywordAnnotations)(nil),                                        // 13: google.ads.googleads.v7.common.KeywordAnnotations
}
var file_services_keyword_plan_idea_service_proto_depIdxs = []int32{
	7,  // 0: google.ads.googleads.v7.services.GenerateKeywordIdeasRequest.keyword_plan_network:type_name -> google.ads.googleads.v7.enums.KeywordPlanNetworkEnum.KeywordPlanNetwork
	8,  // 1: google.ads.googleads.v7.services.GenerateKeywordIdeasRequest.keyword_annotation:type_name -> google.ads.googleads.v7.enums.KeywordPlanKeywordAnnotationEnum.KeywordPlanKeywordAnnotation
	9,  // 2: google.ads.googleads.v7.services.GenerateKeywordIdeasRequest.aggregate_metrics:type_name -> google.ads.googleads.v7.common.KeywordPlanAggregateMetrics
	10, // 3: google.ads.googleads.v7.services.GenerateKeywordIdeasRequest.historical_metrics_options:type_name -> google.ads.googleads.v7.common.HistoricalMetricsOptions
	1,  // 4: google.ads.googleads.v7.services.GenerateKeywordIdeasRequest.keyword_and_url_seed:type_name -> google.ads.googleads.v7.services.KeywordAndUrlSeed
	2,  // 5: google.ads.googleads.v7.services.GenerateKeywordIdeasRequest.keyword_seed:type_name -> google.ads.googleads.v7.services.KeywordSeed
	4,  // 6: google.ads.googleads.v7.services.GenerateKeywordIdeasRequest.url_seed:type_name -> google.ads.googleads.v7.services.UrlSeed
	3,  // 7: google.ads.googleads.v7.services.GenerateKeywordIdeasRequest.site_seed:type_name -> google.ads.googleads.v7.services.SiteSeed
	6,  // 8: google.ads.googleads.v7.services.GenerateKeywordIdeaResponse.results:type_name -> google.ads.googleads.v7.services.GenerateKeywordIdeaResult
	11, // 9: google.ads.googleads.v7.services.GenerateKeywordIdeaResponse.aggregate_metric_results:type_name -> google.ads.googleads.v7.common.KeywordPlanAggregateMetricResults
	12, // 10: google.ads.googleads.v7.services.GenerateKeywordIdeaResult.keyword_idea_metrics:type_name -> google.ads.googleads.v7.common.KeywordPlanHistoricalMetrics
	13, // 11: google.ads.googleads.v7.services.GenerateKeywordIdeaResult.keyword_annotations:type_name -> google.ads.googleads.v7.common.KeywordAnnotations
	0,  // 12: google.ads.googleads.v7.services.KeywordPlanIdeaService.GenerateKeywordIdeas:input_type -> google.ads.googleads.v7.services.GenerateKeywordIdeasRequest
	5,  // 13: google.ads.googleads.v7.services.KeywordPlanIdeaService.GenerateKeywordIdeas:output_type -> google.ads.googleads.v7.services.GenerateKeywordIdeaResponse
