...
var file_services_customer_user_access_invitation_service_proto_rawDesc = []byte{
	...
	0x65, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x47, 0x22, 0x42, 0x2f, 0x76, 0x37, 0x2f, 0x63, 0x75, 0x73,
...
var file_services_customer_user_access_invitation_service_proto_goTypes = []interface{}{
	(*GetCustomerUserAccessInvitationRequest)(nil),     // 0: google.ads.googleads.v7.services.GetCustomerUserAccessInvitationRequest
	(*MutateCustomerUserAccessInvitationRequest)(nil),  // 1: google.ads.googleads.v7.services.MutateCustomerUserAccessInvitationRequest
	(*CustomerUserAccessInvitationOperation)(nil),      // 2: google.ads.googleads.v7.services.CustomerUserAccessInvitationOperation
	(*MutateCustomerUserAccessInvitationResponse)(nil), // 3: google.ads.googleads.v7.services.MutateCustomerUserAccessInvitationResponse
	(*MutateCustomerUserAccessInvitationResult)(nil),   // 4: google.ads.googleads.v7.services.MutateCustomerUserAccessInvitationResult
	(*resources.CustomerUserAccessInvitation)(nil),     // 5: google.ads.googleads.v7.resources.CustomerUserAccessInvitation
}
var file_services_customer_user_access_invitation_service_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v7.services.MutateCustomerUserAccessInvitationRequest.operation:type_name -> google.ads.googleads.v7.services.CustomerUserAccessInvitationOperation
	5, // 1: google.ads.googleads.v7.services.CustomerUserAccessInvitationOperation.create:type_name -> google.ads.googleads.v7.resources.CustomerUserAccessInvitation
	4, // 2: google.ads.googleads.v7.services.MutateCustomerUserAccessInvitationResponse.result:type_name -> google.ads.googleads.v7.services.MutateCustomerUserAccessInvitationResult
	0, // 3: google.ads.googleads.v7.services.CustomerUserAccessInvitationService.GetCustomerUserAccessInvitation:input_type -> google.ads.googleads.v7.services.GetCustomerUserAccessInvitationRequest
	1, // 4: google.ads.googleads.v7.services.CustomerUserAccessInvitationService.MutateCustomerUserAccessInvitation:input_type -> google.ads.googleads.v7.services.MutateCustomerUserAccessInvitationRequest
	5, // 5: google.ads.googleads.v7.services.CustomerUserAccessInvitationService.GetCustomerUserAccessInvitation:output_type -> google.ads.googleads.v7.resources.CustomerUserAccessInvitation
	3, // 6: google.ads.googleads.v7.services.CustomerUserAccessInvitationService.MutateCustomerUserAccessInvitation:output_type -> google.ads.googleads.v7.services.MutateCustomerUserAccessInvitationResponse
