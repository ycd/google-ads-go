...
func (c *mobileDeviceConstantServiceClient) GetMobileDeviceConstant(ctx context.Context, in *GetMobileDeviceConstantRequest, opts ...grpc.CallOption) (*resources.MobileDeviceConstant, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v7.services.MobileDeviceConstantService/GetMobileDeviceConstant", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MobileDeviceConstantService_GetMobileDeviceConstant_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v7.services.MobileDeviceConstantService/GetMobileDeviceConstant",
	}
...
var MobileDeviceConstantService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "google.ads.googleads.v7.services.MobileDeviceConstantService",
	...
	Metadata: "google/ads/googleads/v7/services/mobile_device_constant_service.proto",
}
