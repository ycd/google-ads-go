...
var file_services_campaign_feed_service_proto_goTypes = []interface{}{
	(*GetCampaignFeedRequest)(nil),                         // 0: google.ads.googleads.v7.services.GetCampaignFeedRequest
	(*MutateCampaignFeedsRequest)(nil),                     // 1: google.ads.googleads.v7.services.MutateCampaignFeedsRequest
	(*CampaignFeedOperation)(nil),                          // 2: google.ads.googleads.v7.services.CampaignFeedOperation
	(*MutateCampaignFeedsResponse)(nil),                    // 3: google.ads.googleads.v7.services.MutateCampaignFeedsResponse
	(*MutateCampaignFeedResult)(nil),                       // 4: google.ads.googleads.v7.services.MutateCampaignFeedResult
	...
	(*resources.CampaignFeed)(nil),                         // 7: google.ads.googleads.v7.resources.CampaignFeed
	(*status.Status)(nil),                                  // 8: google.rpc.Status
}
var file_services_campaign_feed_service_proto_depIdxs = []int32{
	2,  // 0: google.ads.googleads.v7.services.MutateCampaignFeedsRequest.operations:type_name -> google.ads.googleads.v7.services.CampaignFeedOperation
	5,  // 1: google.ads.googleads.v7.services.MutateCampaignFeedsRequest.response_content_type:type_name -> google.ads.googleads.v7.enums.ResponseContentTypeEnum.ResponseContentType
	6,  // 2: google.ads.googleads.v7.services.CampaignFeedOperation.update_mask:type_name -> google.protobuf.FieldMask
	7,  // 3: google.ads.googleads.v7.services.CampaignFeedOperation.create:type_name -> google.ads.googleads.v7.resources.CampaignFeed
	7,  // 4: google.ads.googleads.v7.services.CampaignFeedOperation.update:type_name -> google.ads.googleads.v7.resources.CampaignFeed
	8,  // 5: google.ads.googleads.v7.services.MutateCampaignFeedsResponse.partial_failure_error:type_name -> google.rpc.Status
	4,  // 6: google.ads.googleads.v7.services.MutateCampaignFeedsResponse.results:type_name -> google.ads.googleads.v7.services.MutateCampaignFeedResult
	7,  // 7: google.ads.googleads.v7.services.MutateCampaignFeedResult.campaign_feed:type_name -> google.ads.googleads.v7.resources.CampaignFeed
	0,  // 8: google.ads.googleads.v7.services.CampaignFeedService.GetCampaignFeed:input_type -> google.ads.googleads.v7.services.GetCampaignFeedRequest
	1,  // 9: google.ads.googleads.v7.services.CampaignFeedService.MutateCampaignFeeds:input_type -> google.ads.googleads.v7.services.MutateCampaignFeedsRequest
	7,  // 10: google.ads.googleads.v7.services.CampaignFeedService.GetCampaignFeed:output_type -> google.ads.googleads.v7.resources.CampaignFeed
	3,  // 11: google.ads.googleads.v7.services.CampaignFeedService.MutateCampaignFeeds:output_type -> google.ads.googleads.v7.services.MutateCampaignFeedsResponse
