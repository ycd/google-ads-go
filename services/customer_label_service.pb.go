...
var file_services_customer_label_service_proto_goTypes = []interface{}{
	(*GetCustomerLabelRequest)(nil),      // 0: google.ads.googleads.v7.services.GetCustomerLabelRequest
	(*MutateCustomerLabelsRequest)(nil),  // 1: google.ads.googleads.v7.services.MutateCustomerLabelsRequest
	(*CustomerLabelOperation)(nil),       // 2: google.ads.googleads.v7.services.CustomerLabelOperation
	(*MutateCustomerLabelsResponse)(nil), // 3: google.ads.googleads.v7.services.MutateCustomerLabelsResponse
	(*MutateCustomerLabelResult)(nil),    // 4: google.ads.googleads.v7.services.MutateCustomerLabelResult
	(*resources.CustomerLabel)(nil),      // 5: google.ads.googleads.v7.resources.CustomerLabel
	(*status.Status)(nil),                // 6: google.rpc.Status
}
var file_services_customer_label_service_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v7.services.MutateCustomerLabelsRequest.operations:type_name -> google.ads.googleads.v7.services.CustomerLabelOperation
	5, // 1: google.ads.googleads.v7.services.CustomerLabelOperation.create:type_name -> google.ads.googleads.v7.resources.CustomerLabel
	6, // 2: google.ads.googleads.v7.services.MutateCustomerLabelsResponse.partial_failure_error:type_name -> google.rpc.Status
	4, // 3: google.ads.googleads.v7.services.MutateCustomerLabelsResponse.results:type_name -> google.ads.googleads.v7.services.MutateCustomerLabelResult
	0, // 4: google.ads.googleads.v7.services.CustomerLabelService.GetCustomerLabel:input_type -> google.ads.googleads.v7.services.GetCustomerLabelRequest
	1, // 5: google.ads.googleads.v7.services.CustomerLabelService.MutateCustomerLabels:input_type -> google.ads.googleads.v7.services.MutateCustomerLabelsRequest
	5, // 6: google.ads.googleads.v7.services.CustomerLabelService.GetCustomerLabel:output_type -> google.ads.googleads.v7.resources.CustomerLabel
	3, // 7: google.ads.googleads.v7.services.CustomerLabelService.MutateCustomerLabels:output_type -> google.ads.googleads.v7.services.MutateCustomerLabelsResponse
