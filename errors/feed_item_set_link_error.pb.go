...
var file_errors_feed_item_set_link_error_proto_goTypes = []interface{}{
	(FeedItemSetLinkErrorEnum_FeedItemSetLinkError)(0), // 0: google.ads.googleads.v7.errors.FeedItemSetLinkErrorEnum.FeedItemSetLinkError
	(*FeedItemSetLinkErrorEnum)(nil),                   // 1: google.ads.googleads.v7.errors.FeedItemSetLinkErrorEnum
}
