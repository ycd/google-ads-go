...
var file_errors_field_mask_error_proto_goTypes = []interface{}{
	(FieldMaskErrorEnum_FieldMaskError)(0), // 0: google.ads.googleads.v7.errors.FieldMaskErrorEnum.FieldMaskError
	(*FieldMaskErrorEnum)(nil),             // 1: google.ads.googleads.v7.errors.FieldMaskErrorEnum
}
