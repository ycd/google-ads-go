...
var file_errors_label_error_proto_goTypes = []interface{}{
	(LabelErrorEnum_LabelError)(0), // 0: google.ads.googleads.v7.errors.LabelErrorEnum.LabelError
	(*LabelErrorEnum)(nil),         // 1: google.ads.googleads.v7.errors.LabelErrorEnum
}
