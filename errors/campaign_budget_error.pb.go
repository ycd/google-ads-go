...
var file_errors_campaign_budget_error_proto_goTypes = []interface{}{
	(CampaignBudgetErrorEnum_CampaignBudgetError)(0), // 0: google.ads.googleads.v7.errors.CampaignBudgetErrorEnum.CampaignBudgetError
	(*CampaignBudgetErrorEnum)(nil),                  // 1: google.ads.googleads.v7.errors.CampaignBudgetErrorEnum
}
