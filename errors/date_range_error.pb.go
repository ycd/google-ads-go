...
var file_errors_date_range_error_proto_goTypes = []interface{}{
	(DateRangeErrorEnum_DateRangeError)(0), // 0: google.ads.googleads.v7.errors.DateRangeErrorEnum.DateRangeError
	(*DateRangeErrorEnum)(nil),             // 1: google.ads.googleads.v7.errors.DateRangeErrorEnum
}
