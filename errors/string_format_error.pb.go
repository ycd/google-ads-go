...
var file_errors_string_format_error_proto_goTypes = []interface{}{
	(StringFormatErrorEnum_StringFormatError)(0), // 0: google.ads.googleads.v7.errors.StringFormatErrorEnum.StringFormatError
	(*StringFormatErrorEnum)(nil),                // 1: google.ads.googleads.v7.errors.StringFormatErrorEnum
}
