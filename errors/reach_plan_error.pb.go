...
var file_errors_reach_plan_error_proto_goTypes = []interface{}{
	(ReachPlanErrorEnum_ReachPlanError)(0), // 0: google.ads.googleads.v7.errors.ReachPlanErrorEnum.ReachPlanError
	(*ReachPlanErrorEnum)(nil),             // 1: google.ads.googleads.v7.errors.ReachPlanErrorEnum
}
