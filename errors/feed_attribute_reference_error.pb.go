...
var file_errors_feed_attribute_reference_error_proto_goTypes = []interface{}{
	(FeedAttributeReferenceErrorEnum_FeedAttributeReferenceError)(0), // 0: google.ads.googleads.v7.errors.FeedAttributeReferenceErrorEnum.FeedAttributeReferenceError
	(*FeedAttributeReferenceErrorEnum)(nil),                          // 1: google.ads.googleads.v7.errors.FeedAttributeReferenceErrorEnum
}
