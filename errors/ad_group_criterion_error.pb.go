...
var file_errors_ad_group_criterion_error_proto_goTypes = []interface{}{
	(AdGroupCriterionErrorEnum_AdGroupCriterionError)(0), // 0: google.ads.googleads.v7.errors.AdGroupCriterionErrorEnum.AdGroupCriterionError
	(*AdGroupCriterionErrorEnum)(nil),                    // 1: google.ads.googleads.v7.errors.AdGroupCriterionErrorEnum
}
