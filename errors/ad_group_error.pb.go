...
var file_errors_ad_group_error_proto_goTypes = []interface{}{
	(AdGroupErrorEnum_AdGroupError)(0), // 0: google.ads.googleads.v7.errors.AdGroupErrorEnum.AdGroupError
	(*AdGroupErrorEnum)(nil),           // 1: google.ads.googleads.v7.errors.AdGroupErrorEnum
}
