...
var file_errors_batch_job_error_proto_goTypes = []interface{}{
	(BatchJobErrorEnum_BatchJobError)(0), // 0: google.ads.googleads.v7.errors.BatchJobErrorEnum.BatchJobError
	(*BatchJobErrorEnum)(nil),            // 1: google.ads.googleads.v7.errors.BatchJobErrorEnum
}
