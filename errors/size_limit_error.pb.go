...
var file_errors_size_limit_error_proto_goTypes = []interface{}{
	(SizeLimitErrorEnum_SizeLimitError)(0), // 0: google.ads.googleads.v7.errors.SizeLimitErrorEnum.SizeLimitError
	(*SizeLimitErrorEnum)(nil),             // 1: google.ads.googleads.v7.errors.SizeLimitErrorEnum
}
