...
type FrequencyCapKey struct {
	...
	Level enums.FrequencyCapLevelEnum_FrequencyCapLevel `protobuf:"varint,1,opt,name=level,proto3,enum=google.ads.googleads.v7.enums.FrequencyCapLevelEnum_FrequencyCapLevel" json:"level,omitempty"`
	// The type of event that the cap applies to (e.g. impression).
	EventType enums.FrequencyCapEventTypeEnum_FrequencyCapEventType `protobuf:"varint,3,opt,name=event_type,json=eventType,proto3,enum=google.ads.googleads.v7.enums.FrequencyCapEventTypeEnum_FrequencyCapEventType" json:"event_type,omitempty"`
...
var file_common_frequency_cap_proto_rawDesc = []byte{
	...
	0x73, 0x2f, 0x76, 0x37, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x66, 0x72, 0x65, 0x71, 0x75,
	...
	0x76, 0x37, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x46, 0x72, 0x65, 0x71, 0x75, 0x65,
...
var file_common_frequency_cap_proto_goTypes = []interface{}{
	(*FrequencyCapEntry)(nil),                                  // 0: google.ads.googleads.v7.common.FrequencyCapEntry
	(*FrequencyCapKey)(nil),                                    // 1: google.ads.googleads.v7.common.FrequencyCapKey
	(enums.FrequencyCapLevelEnum_FrequencyCapLevel)(0),         // 2: google.ads.googleads.v7.enums.FrequencyCapLevelEnum.FrequencyCapLevel
	(enums.FrequencyCapEventTypeEnum_FrequencyCapEventType)(0), // 3: google.ads.googleads.v7.enums.FrequencyCapEventTypeEnum.FrequencyCapEventType
	(enums.FrequencyCapTimeUnitEnum_FrequencyCapTimeUnit)(0),   // 4: google.ads.googleads.v7.enums.FrequencyCapTimeUnitEnum.FrequencyCapTimeUnit
}
var file_common_frequency_cap_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v7.common.FrequencyCapEntry.key:type_name -> google.ads.googleads.v7.common.FrequencyCapKey
	2, // 1: google.ads.googleads.v7.common.FrequencyCapKey.level:type_name -> google.ads.googleads.v7.enums.FrequencyCapLevelEnum.FrequencyCapLevel
	3, // 2: google.ads.googleads.v7.common.FrequencyCapKey.event_type:type_name -> google.ads.googleads.v7.enums.FrequencyCapEventTypeEnum.FrequencyCapEventType
	4, // 3: google.ads.googleads.v7.common.FrequencyCapKey.time_unit:type_name -> google.ads.googleads.v7.enums.FrequencyCapTimeUnitEnum.FrequencyCapTimeUnit
