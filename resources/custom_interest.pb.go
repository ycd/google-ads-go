...
type CustomInterest struct {
	...
	// enabled or removed.
	Status enums.CustomInterestStatusEnum_CustomInterestStatus `protobuf:"varint,3,opt,name=status,proto3,enum=google.ads.googleads.v7.enums.CustomInterestStatusEnum_CustomInterestStatus" json:"status,omitempty"`
	...
	Type enums.CustomInterestTypeEnum_CustomInterestType `protobuf:"varint,5,opt,name=type,proto3,enum=google.ads.googleads.v7.enums.CustomInterestTypeEnum_CustomInterestType" json:"type,omitempty"`
...
type CustomInterestMember struct {
	...
	MemberType enums.CustomInterestMemberTypeEnum_CustomInterestMemberType `protobuf:"varint,1,opt,name=member_type,json=memberType,proto3,enum=google.ads.googleads.v7.enums.CustomInterestMemberTypeEnum_CustomInterestMemberType" json:"member_type,omitempty"`
...
var file_resources_custom_interest_proto_rawDesc = []byte{
	...
	0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x37, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x43, 0x75,
	...
	0x73, 0x2e, 0x76, 0x37, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0x13,
...
var file_resources_custom_interest_proto_goTypes = []interface{}{
	(*CustomInterest)(nil),                                           // 0: google.ads.googleads.v7.resources.CustomInterest
	(*CustomInterestMember)(nil),                                     // 1: google.ads.googleads.v7.resources.CustomInterestMember
	(enums.CustomInterestStatusEnum_CustomInterestStatus)(0),         // 2: google.ads.googleads.v7.enums.CustomInterestStatusEnum.CustomInterestStatus
	(enums.CustomInterestTypeEnum_CustomInterestType)(0),             // 3: google.ads.googleads.v7.enums.CustomInterestTypeEnum.CustomInterestType
	(enums.CustomInterestMemberTypeEnum_CustomInterestMemberType)(0), // 4: google.ads.googleads.v7.enums.CustomInterestMemberTypeEnum.CustomInterestMemberType
}
var file_resources_custom_interest_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v7.resources.CustomInterest.status:type_name -> google.ads.googleads.v7.enums.CustomInterestStatusEnum.CustomInterestStatus
	3, // 1: google.ads.googleads.v7.resources.CustomInterest.type:type_name -> google.ads.googleads.v7.enums.CustomInterestTypeEnum.CustomInterestType
	1, // 2: google.ads.googleads.v7.resources.CustomInterest.members:type_name -> google.ads.googleads.v7.resources.CustomInterestMember
	4, // 3: google.ads.googleads.v7.resources.CustomInterestMember.member_type:type_name -> google.ads.googleads.v7.enums.CustomInterestMemberTypeEnum.CustomInterestMemberType
