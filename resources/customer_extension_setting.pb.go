...
type CustomerExtensionSetting struct {
	...
	Device enums.ExtensionSettingDeviceEnum_ExtensionSettingDevice `protobuf:"varint,4,opt,name=device,proto3,enum=google.ads.googleads.v7.enums.ExtensionSettingDeviceEnum_ExtensionSettingDevice" json:"device,omitempty"`
}
...
var file_resources_customer_extension_setting_proto_goTypes = []interface{}{
	(*CustomerExtensionSetting)(nil),                             // 0: google.ads.googleads.v7.resources.CustomerExtensionSetting
...
var file_resources_customer_extension_setting_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v7.resources.CustomerExtensionSetting.extension_type:type_name -> google.ads.googleads.v7.enums.ExtensionTypeEnum.ExtensionType
	2, // 1: google.ads.googleads.v7.resources.CustomerExtensionSetting.device:type_name -> google.ads.googleads.v7.enums.ExtensionSettingDeviceEnum.ExtensionSettingDevice
