...
type CampaignSharedSet struct {
	...
	Status enums.CampaignSharedSetStatusEnum_CampaignSharedSetStatus `protobuf:"varint,2,opt,name=status,proto3,enum=google.ads.googleads.v7.enums.CampaignSharedSetStatusEnum_CampaignSharedSetStatus" json:"status,omitempty"`
}
...
var file_resources_campaign_shared_set_proto_goTypes = []interface{}{
	(*CampaignSharedSet)(nil),                                      // 0: google.ads.googleads.v7.resources.CampaignSharedSet
	(enums.CampaignSharedSetStatusEnum_CampaignSharedSetStatus)(0), // 1: google.ads.googleads.v7.enums.CampaignSharedSetStatusEnum.CampaignSharedSetStatus
}
var file_resources_campaign_shared_set_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v7.resources.CampaignSharedSet.status:type_name -> google.ads.googleads.v7.enums.CampaignSharedSetStatusEnum.CampaignSharedSetStatus
