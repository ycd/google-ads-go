...
type BatchJob struct {
	...
	Status enums.BatchJobStatusEnum_BatchJobStatus `protobuf:"varint,5,opt,name=status,proto3,enum=google.ads.googleads.v7.enums.BatchJobStatusEnum_BatchJobStatus" json:"status,omitempty"`
...
var file_resources_batch_job_proto_rawDesc = []byte{
	...
	0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x37, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x42, 0x61,
	...
	0x76, 0x37, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0x0d, 0x42, 0x61,
...
var file_resources_batch_job_proto_goTypes = []interface{}{
	(*BatchJob)(nil),                             // 0: google.ads.googleads.v7.resources.BatchJob
	(*BatchJob_BatchJobMetadata)(nil),            // 1: google.ads.googleads.v7.resources.BatchJob.BatchJobMetadata
	(enums.BatchJobStatusEnum_BatchJobStatus)(0), // 2: google.ads.googleads.v7.enums.BatchJobStatusEnum.BatchJobStatus
}
var file_resources_batch_job_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v7.resources.BatchJob.metadata:type_name -> google.ads.googleads.v7.resources.BatchJob.BatchJobMetadata
	2, // 1: google.ads.googleads.v7.resources.BatchJob.status:type_name -> google.ads.googleads.v7.enums.BatchJobStatusEnum.BatchJobStatus
