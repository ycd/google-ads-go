...
type KeywordPlanAdGroupKeyword struct {
	...
	MatchType enums.KeywordMatchTypeEnum_KeywordMatchType `protobuf:"varint,5,opt,name=match_type,json=matchType,proto3,enum=google.ads.googleads.v7.enums.KeywordMatchTypeEnum_KeywordMatchType" json:"match_type,omitempty"`
...
var file_resources_keyword_plan_ad_group_keyword_proto_goTypes = []interface{}{
	(*KeywordPlanAdGroupKeyword)(nil),                // 0: google.ads.googleads.v7.resources.KeywordPlanAdGroupKeyword
	(enums.KeywordMatchTypeEnum_KeywordMatchType)(0), // 1: google.ads.googleads.v7.enums.KeywordMatchTypeEnum.KeywordMatchType
}
var file_resources_keyword_plan_ad_group_keyword_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v7.resources.KeywordPlanAdGroupKeyword.match_type:type_name -> google.ads.googleads.v7.enums.KeywordMatchTypeEnum.KeywordMatchType
