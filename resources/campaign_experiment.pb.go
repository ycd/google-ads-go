...
type CampaignExperiment struct {
	...
	Status enums.CampaignExperimentStatusEnum_CampaignExperimentStatus `protobuf:"varint,9,opt,name=status,proto3,enum=google.ads.googleads.v7.enums.CampaignExperimentStatusEnum_CampaignExperimentStatus" json:"status,omitempty"`
...
var file_resources_campaign_experiment_proto_rawDesc = []byte{
	...
	0x76, 0x37, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x43, 0x61, 0x6d, 0x70, 0x61, 0x69, 0x67,
	...
	0x73, 0x2e, 0x76, 0x37, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x43, 0x61, 0x6d, 0x70, 0x61,
...
var file_resources_campaign_experiment_proto_goTypes = []interface{}{
	(*CampaignExperiment)(nil), // 0: google.ads.googleads.v7.resources.CampaignExperiment
	(enums.CampaignExperimentTrafficSplitTypeEnum_CampaignExperimentTrafficSplitType)(0), // 1: google.ads.googleads.v7.enums.CampaignExperimentTrafficSplitTypeEnum.CampaignExperimentTrafficSplitType
	(enums.CampaignExperimentStatusEnum_CampaignExperimentStatus)(0),                     // 2: google.ads.googleads.v7.enums.CampaignExperimentStatusEnum.CampaignExperimentStatus
}
var file_resources_campaign_experiment_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v7.resources.CampaignExperiment.traffic_split_type:type_name -> google.ads.googleads.v7.enums.CampaignExperimentTrafficSplitTypeEnum.CampaignExperimentTrafficSplitType
	2, // 1: google.ads.googleads.v7.resources.CampaignExperiment.status:type_name -> google.ads.googleads.v7.enums.CampaignExperimentStatusEnum.CampaignExperimentStatus
