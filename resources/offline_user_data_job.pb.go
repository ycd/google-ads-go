...
type OfflineUserDataJob struct {
	...
	Type enums.OfflineUserDataJobTypeEnum_OfflineUserDataJobType `protobuf:"varint,4,opt,name=type,proto3,enum=google.ads.googleads.v7.enums.OfflineUserDataJobTypeEnum_OfflineUserDataJobType" json:"type,omitempty"`
	// Output only. Status of the job.
	Status enums.OfflineUserDataJobStatusEnum_OfflineUserDataJobStatus `protobuf:"varint,5,opt,name=status,proto3,enum=google.ads.googleads.v7.enums.OfflineUserDataJobStatusEnum_OfflineUserDataJobStatus" json:"status,omitempty"`
	// Output only. Reason for the processing failure, if status is FAILED.
	FailureReason enums.OfflineUserDataJobFailureReasonEnum_OfflineUserDataJobFailureReason `protobuf:"varint,6,opt,name=failure_reason,json=failureReason,proto3,enum=google.ads.googleads.v7.enums.OfflineUserDataJobFailureReasonEnum_OfflineUserDataJobFailureReason" json:"failure_reason,omitempty"`
	// Metadata of the job.
	//
...
var file_resources_offline_user_data_job_proto_rawDesc = []byte{
	...
	0x2f, 0x76, 0x37, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x6f, 0x66, 0x66, 0x6c, 0x69, 0x6e,
	...
	0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x37, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x4f, 0x66,
	...
	0x2e, 0x76, 0x37, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0x17, 0x4f,
	0x66, 0x66, 0x6c, 0x69, 0x6e, 0x65, 0x55, 0x73, 0x65, 0x72, 0x44, 0x61, 0x74, 0x61, 0x4a, 0x6f,
...
var file_resources_offline_user_data_job_proto_goTypes = []interface{}{
	(*OfflineUserDataJob)(nil),                                                     // 0: google.ads.googleads.v7.resources.OfflineUserDataJob
	(enums.OfflineUserDataJobTypeEnum_OfflineUserDataJobType)(0),                   // 1: google.ads.googleads.v7.enums.OfflineUserDataJobTypeEnum.OfflineUserDataJobType
	(enums.OfflineUserDataJobStatusEnum_OfflineUserDataJobStatus)(0),               // 2: google.ads.googleads.v7.enums.OfflineUserDataJobStatusEnum.OfflineUserDataJobStatus
	(enums.OfflineUserDataJobFailureReasonEnum_OfflineUserDataJobFailureReason)(0), // 3: google.ads.googleads.v7.enums.OfflineUserDataJobFailureReasonEnum.OfflineUserDataJobFailureReason
	(*common.CustomerMatchUserListMetadata)(nil),                                   // 4: google.ads.googleads.v7.common.CustomerMatchUserListMetadata
	(*common.StoreSalesMetadata)(nil),                                              // 5: google.ads.googleads.v7.common.StoreSalesMetadata
}
var file_resources_offline_user_data_job_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v7.resources.OfflineUserDataJob.type:type_name -> google.ads.googleads.v7.enums.OfflineUserDataJobTypeEnum.OfflineUserDataJobType
	2, // 1: google.ads.googleads.v7.resources.OfflineUserDataJob.status:type_name -> google.ads.googleads.v7.enums.OfflineUserDataJobStatusEnum.OfflineUserDataJobStatus
	3, // 2: google.ads.googleads.v7.resources.OfflineUserDataJob.failure_reason:type_name -> google.ads.googleads.v7.enums.OfflineUserDataJobFailureReasonEnum.OfflineUserDataJobFailureReason
	4, // 3: google.ads.googleads.v7.resources.OfflineUserDataJob.customer_match_user_list_metadata:type_name -> google.ads.googleads.v7.common.CustomerMatchUserListMetadata
	5, // 4: google.ads.googleads.v7.resources.OfflineUserDataJob.store_sales_metadata:type_name -> google.ads.googleads.v7.common.StoreSalesMetadata
